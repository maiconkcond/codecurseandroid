	...
	public void render () {
        ...
        if (estadoJogo == 0){
            ...
            if (estadoJogo == 1){
                ...
                // verifica potuaçao
                if (posicaoMovimentaCanoHorizontal < 120){
                    if (!marcouPonto){
                        pontuacao++;
                        marcouPonto = true;
                    }
        ...
        if (estadoJogo == 2){
            ...
            mensagem.draw(batch,"Toque para reiniciar", larguraDispositivo / 2 - 200, alturaDispositivo / 2 - GameOver.getWidth() / 2 );
        }
        ...
        RetanguloCanoBaixo = new Rectangle(
                posicaoMovimentaCanoHorizontal,
                alturaDispositivo / 2 - canoBaixo.getHeight() - espacoEntreCanos / 2 + alturaEntreCanosRandomica,
                canoBaixo.getWidth(), canoBaixo.getHeight()
        );

        RetanguloCanoTopo = new Rectangle(
                posicaoMovimentaCanoHorizontal, alturaDispositivo / 2 + espacoEntreCanos / 2 + alturaEntreCanosRandomica,
